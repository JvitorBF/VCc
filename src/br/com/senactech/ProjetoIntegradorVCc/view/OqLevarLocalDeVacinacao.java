 ...
 * @author faria
 */
public class OqLevarLocalDeVacinacao extends javax.swing.JFrame {

    /**
     * Creates new form GruposPrioritarios
     */
    public OqLevarLocalDeVacinacao() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelParagrafo.setText("<html><h3>Todas as pessoas serão vacinadas</h3><p>Mesmo que não apresentem algum documento. "
            ...
            + "CPF ou apresentar o Cartão Nacional de Saúde (CNS) – o Cartão do SUS.</p>"
            + "<ol>"
            + "<li> Identidade;</li>"
            + "<li> Cartão SUS;</li>"
            + "<li> Caso for a segunda ou mais doses, levar carteira de vacinação.</li>"
            + "</ol>"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OqLevarLocalDeVacinacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OqLevarLocalDeVacinacao().setVisible(true);
            }
        });
    }
